...
public class CoreJAVAExercise3 {

	public static void main(String[] args) {
		// TODO Auto-generated method stub

		CoreJAVAExercise3 coreJAVAExercise3 = new CoreJAVAExercise3();
		int arr[] = {3, 1, 2, 24, 21, 90, 12, 33, 28, 99, 150,133,30,15,81};
		int searchKey=1000;
		
		//Count the number of odd numbers divisible by 3 in even positions.
		System.out.println("The number of odd numbers divisible by 3 in even positions = " + coreJAVAExercise3.oddNumberCounter(arr));
		
		//Search for a key value in array and print it is available in the array or not.
		searchKey=81;
		if(coreJAVAExercise3.searchKeyInArray(arr,searchKey) == false) {
		...
		coreJAVAExercise3.countPrimeNumber(arr);
	}
